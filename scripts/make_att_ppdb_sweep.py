...
gflags.DEFINE_string("ppdb_path", "/home/xz1364/mlworkspace/ppdb/ppdb2-s-parsed.tsv", "ppdb path")
...
SWEEP_PARAMETERS = {
    ...
    'mlp_dim': ('mlpd', SS_SET, [256, 512], 0),   # 0 is useless
    #'model_dim': ('mdim', SS_SET, [300, 400, 600], 0),  # 0 is useless
    'num_mlp_layers': ('mlpl', SS_SET, [1,2], 0),
    'ppdb_loss_weight' : ('ppdb_loss_weight', EXP, 0.1, 10),
